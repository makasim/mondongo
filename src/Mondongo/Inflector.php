...
class Inflector
{
    ...
    /**
     * Generates a field name for a class.
     *
     * @param string $class The class.
     *
     * @return string The field name.
     */
    static public function fieldForClass($class)
    {
        if (false !== $pos = strrpos($class, '\\')) {
            $class = substr($class, $pos + 1);
        }

        return static::underscore($class).'_id';
    }

    /**
     * Generates a plural field name for a class.
     *
     * @param string $class The class.
     *
     * @return string The field name.
     */
    static public function pluralFieldForClass($class)
    {
        return static::fieldForClass($class).'s';
    }
}
